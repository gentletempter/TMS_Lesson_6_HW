...
public class UserRegistration {
    public static void register(String login, String password, String confirmPassword) {
        try {
            System.out.println(registerUser(login, password, confirmPassword));
     ...
     * @return {@code true} when the login and password are valid, else return {@code exception message}
     ...
     */
    private static boolean registerUser(String login, String password, String confirmPassword) throws WrongLoginException, WrongPasswordException {
